...
const ambassadorClubs = () => {
    ...
    <Link href={'/new-artist'} className="flex shadow uppercase justify-center bg-gradient-to-r from-[#6c54ad] to-[#f04762] px-7 py-3.5 rounded-full w-fit m-auto text-white hover:text-blue-400 font-semibold">
            emerge now
          </Link>
...
export default ambassadorClubs