...
export default function Home() {
  ...
  return (
    ...
    <Head>
      ...
      <meta name="description" content="Distribute your music to major streaming platforms like Spotify , Apple Music and more. Expand your audience and boost revenue with Emergence Music Distribution." />
