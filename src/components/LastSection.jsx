...
const LastSection = () => {
  return (
    ...
    <h2 className='text-4xl sm:text-3xl order-2 font-bold sm:px-4 capitalize py-6 text-center'>distribute and sell your music video</h2> 
    ...
    <Image width={500} height={500} className='w-[16.9rem] order-1 m-auto mt-7' src="/images/vevo.png" alt="Vevo" />
    </div>
    ...
    <div className='md:w-full sm:w-full space-y-2 flex-1'>
        <Image width={100} height={100} className='w-[16.3rem] m-auto'  src="/images/emerge.svg" alt="Emerge" />
        <h3 className='text-3xl capitalize font-bold text-center'>emerge with us</h3>
        <p className=' text-center capitalize text-l text-[#a1a1a1] md:w-full sm:w-full'>
    ...
    <div className='md:w-full sm:w-full space-y-2 flex-1'>
        <Image width={100} height={100} className='w-[16.3rem] m-auto'  src="/images/develop.svg" alt="develope" />
        <h2 className='text-3xl font-bold capitalize text-center'>how to develop your music career</h2>
        <p className='text-center capitalize text-l text-[#a1a1a1] md:w-full sm:w-full'>
