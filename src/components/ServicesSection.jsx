...
const ServicesSection = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#35222d] to-[#3e2b47]  py-7 space-y-5 sm:px-3">
    ...
    <Link href={'/services'} className="flex shadow capitalize justify-center bg-gradient-to-r from-[#6c54ad] to-[#f04762] px-7 py-3.5 rounded-full w-fit m-auto text-white hover:text-blue-400 font-semibold">
      view all services
    </Link>
  </div>
  )
