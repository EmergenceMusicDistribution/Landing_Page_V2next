        ...
        <div className='flex flex-col gap-3 sm:items-center'>
            ...
            <form className='flex flex-col gap-2' action="">
                ...
                onClick={(e)=>{
                 ...
                 className='text-white uppercase font-semibold w-fit bg-gradient-to-r from-[#6c54ad] to-[#f04762] hover:text-blue-500 rounded-md py-3.5 px-5 sm:m-auto' type='submit'> 
                 {subScribeStatus}
                 </button>
            </form>
        </div>
